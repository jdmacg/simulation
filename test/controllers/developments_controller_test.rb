...
class DevelopmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create development" do
    assert_difference('Development.count') do
      post developments_url, params: { development: { cost: @development.cost, used: @development.used } }
    end
  ...
  test "should update development" do
    patch development_url(@development), params: { development: { cost: @development.cost, used: @development.used } }
