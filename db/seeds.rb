...
Incentive.create([{description: "3 Properties owned in British Columia", value: 4500000, incentive_type: 1, calculation_key: "province2Count", completed_key: "province2"}])
...
Incentive.create([{description: "2 Properties owned in Quebec", value: 3500000, incentive_type: 1, calculation_key: "province5Count", completed_key: "province5"}])
...
Incentive.create([{description: "5 Acquisitions Completed", value: 5000000, incentive_type: 1, calculation_key: "tradedPropertiesCount", completed_key: "traded1"}])
Incentive.create([{description: "10 Acquisitions Completed", value: 15000000, incentive_type: 1, calculation_key: "tradedPropertiesCount", completed_key: "traded2"}])
Incentive.create([{description: "15 Acquisitions Completed", value: 25000000, incentive_type: 1, calculation_key: "tradedPropertiesCount", completed_key: "traded3"}])
...
Incentive.create([{description: "Most Acquisitions", value: 7000000, incentive_type: 2, calculation_key: "tradedPropertiesCount"}])
Incentive.create([{description: "Most Developments", value: 5000000, incentive_type: 2, calculation_key: "developmentsCount"}])
Incentive.create([{description: "Most Properties Owned", value: 4000000, incentive_type: 2, calculation_key: "propertiesCount"}])
Incentive.create([{description: "Most Industrial Properties Owned", value: 3000000, incentive_type: 2, calculation_key: "propertyType2Count"}])
Incentive.create([{description: "Most Multi-Residential Properties Owned", value: 3000000, incentive_type: 2, calculation_key: "propertyType1Count"}])
Incentive.create([{description: "Most Office Properties Owned", value: 3000000, incentive_type: 2, calculation_key: "propertyType3Count"}])
Incentive.create([{description: "Most Retial Properties Owned", value: 3000000, incentive_type: 2, calculation_key: "propertyType4Count"}])
